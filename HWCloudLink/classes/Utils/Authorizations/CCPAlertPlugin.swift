...
extension CCPAlertPlugin {
    ...
    func title(_ target: CCPAuthorization) -> String {
        ...
        case .microphone:
            return NSLocalizedString("CCPAlertPluginMicrophoneTitle", tableName: "CCPAuthorization", comment: "")
        case .contact:
    ...
    func message(_ target: CCPAuthorization) -> String {
        ...
        case .microphone:
            return NSLocalizedString("CCPAlertPluginMicrophoneMessage", tableName: "CCPAuthorization", comment: "")
        case .contact:
