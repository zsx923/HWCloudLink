 ...
 *是否是SMC3.0
 */
@property (nonatomic, assign)BOOL isSMC3;
 ...
 *当前接听的call对象信息
 */
@property (nonatomic, strong) CallInfo *currentCallInfo;

/**
 * call stream information
 * 呼叫辅流信息
 */
@property (nonatomic,strong) CallStreamInfo *currentCallStreamInfo;

/**
 * LdapContactInfo information
 * 当前账号的 LdapContactInfo
 */
@property (nonatomic,strong) LdapContactInfo *ldapContactInfo;
 ...
 *                                                     [cn] 呼叫ID
 *@return TSDK_S_CALL_STREAM_INFO* call_stream_info   [en] return media information.
 *                                                     [cn] 媒体信息
 */
